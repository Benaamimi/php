...
<body>
    ...
    */
    ...
    // AJOUTER DES INFORMATION A ALA SESSION
    $_SESSION['speudo'] = 'tintin';

    // SUPPRIMER UNE SESSION
    unset($_SESSION['pseudo']);

    // supprimer le fichier de session sans le supprimer du serveur
    session_destroy();

    // vider le fichier de session sans le supprimer du serveur
    session_unset();
     ...
     class Hero{
        ...
        public $pseudo = 'Tintin';//propriété
        public $vie =100;//propriété

        public function regenerer(){ //Méthode
            $this ->vie = 100;
        }
